...
class TestAutocastCPU(TestCase):
    ...
    def _run_autocast_outofplace(self, op, args, run_as_type, out_type=None, module=torch, add_kwargs=None, amp_dtype=torch.bfloat16):
        # helper to cast args
    ...
    def test_autocast_nn_16(self):
        for op_with_args in self.autocast_lists.nn_16:
            ...
            self._run_autocast_outofplace(op, args, torch.float16, module=torch._C._nn, add_kwargs=maybe_kwargs, amp_dtype=torch.float16)
    ...
    def test_autocast_nn_fp32(self):
        for op_with_args in self.autocast_lists.nn_fp32:
            ...
            self._run_autocast_outofplace(op, args, torch.float32, module=torch._C._nn, add_kwargs=maybe_kwargs, amp_dtype=torch.float16)
